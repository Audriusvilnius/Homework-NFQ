...
\t\t\t\t\t<p class=\"text-muted\">";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 16, $this->source); })()), "mins", [], "any", false, false, false, 16), "html", null, true);
        echo "
\t\t\t\t\t\treading times
\t\t\t\t\t</p>
\t\t\t\t</div>
...
\t</div>
    ...
    {
        return array (  92 => 23,  87 => 21,  83 => 20,  76 => 16,  64 => 7,  59 => 4,  52 => 3,  35 => 1,);
    }
